  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (res.error) {
        ...
        // Login ke context/state management
        login(res.loginResult, res.loginResult.token);
        
        // Tampilkan success message
        showSuccessAlert("Login berhasil!");
        
        // Redirect ke halaman home setelah delay singkat
        setTimeout(() => {
          navigate("/"); // atau "/" tergantung routing Anda
        }, 1500); // Delay 1.5 detik untuk menampilkan alert
      }
    } catch (err) {
